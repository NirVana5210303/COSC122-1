import unittest
from quicksort_last_pivot import *
from classes_1 import CounterList, CounterNode
from timeout import timeout
import os
import sys

# use the following line to import your word_counter_bin
...
class TestQuicksortLast(unittest.TestCase):
    ...
    def test_all_counts_same(self):
        ...
        quick_sort_by_count_last_pivot(c_list)
    ...
    def test_short_reverse_order_list(self):
        words = ['apples', 'oranges', 'oranges', 'pears', 'pears',
                 'pears', 'pie', 'pie', 'pie', 'pie', 'pie',
                 'strawberries', 'strawberries', 'strawberries',
                 'strawberries', 'strawberries', 'strawberries',
                 'strawberries', 'strawberries', 'strawberries']
        c_list, comparisons = word_counter_bin(words)
