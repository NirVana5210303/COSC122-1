...
class BinarySearchTree(object):
    ...
    def _in_order_items(self, subtree, out_list):
        ...
        if subtree.left != None:
            return self._in_order_items(subtree.left,out_list)
        elif subtree.right != None:
            return self._in_order_items(subtree.right,out_list)
        else:
    ...
    def pre_order_items(self):
        ...
        out_list = []
        #out_list will be built up as we recurse through the tree
        #out_list is change in-place so no answer is returned from _pre_order_items
    ...
    def _remove(self, node, value):
        ...
        # The item to be deleted IS node!
            ...
            if node.left is None and node.right is None:
                ...
                # it's value will be changed to the value
